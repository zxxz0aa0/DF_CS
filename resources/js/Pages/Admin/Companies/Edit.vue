            ...
            <div class="row">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-end">
                        ...
                        <li class="breadcrumb-item active">編輯公司</li>
                    </ol>
                </div>
            </div>
        </template>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">編輯：{{ company.name }}</h3>
                    </div>
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-8">
                                    ...
                                    <!-- 公司名稱 -->
                                    <div class="mb-3">
                                        <label for="name" class="form-label">公司名稱 <span class="text-danger">*</span></label>
                                        <input
                                            type="text"
                                            id="name"
                                            class="form-control"
                        ...
                        <div class="card-footer">
                            <div class="d-flex gap-2">
                                <button type="submit" class="btn btn-primary" :disabled="form.processing">
                                    ...
                                    {{ form.processing ? '處理中...' : '更新公司' }}
                                </button>
                                <Link :href="route('admin.companies.index')" class="btn btn-secondary">
