            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">新增駕駛</li>
                    </ol>
                </div>
            </div>
        </template>
...
const form = useForm({
    ...
    fleet_join_date: null,
    fleet_leave_date: null,
    license_expire_date: null,
    professional_license_expire_date: null,
    status: 'open',
    notes: ''
})
