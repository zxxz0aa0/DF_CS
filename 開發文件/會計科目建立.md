...
Route::prefix('admin')->name('admin.')->middleware(['auth', 'permission:manage accounts'])->group(function () {
    ...
    // 會計科目明細管理
    Route::get('account-details/export', [AccountDetailController::class, 'export'])->name('account-details.export');
    Route::post('account-details/import', [AccountDetailController::class, 'import'])->name('account-details.import');
    Route::get('account-details/template', [AccountDetailController::class, 'template'])->name('account-details.template');
    Route::resource('account-details', AccountDetailController::class);
    Route::put('account-details/{detail}/toggle-status',
        [AccountDetailController::class, 'toggleStatus'])->name('account-details.toggle-status');

    // API 路由
    Route::prefix('api')->name('api.')->group(function () {
        Route::get('account-main-categories/options', [AccountMainCategoryController::class, 'getOptions']);
        Route::get('account-sub-categories/by-main/{mainId}', [AccountSubCategoryController::class, 'getByMainCategory']);
        Route::get('account-details/validate-code', [AccountDetailController::class, 'validateCode']);
        Route::get('account-details/next-code', [AccountDetailController::class, 'getNextCode']);
    });
          ...
          <div class="row mb-2">
            ...
            <div class="col-sm-6">
              <div class="float-right">
                <Link :href="route('admin.account-details.create')"
                ...
                <a :href="route('admin.account-details.export')"
                  ...
                  <table class="table table-striped table-hover">
                    ...
                    <tbody>
                      <tr v-for="account in accounts.data" :key="account.id">
                        ...
                        <td>
                          <div class="btn-group">
                            <Link :href="route('admin.account-details.show', account.id)"
                                  class="btn btn-sm btn-info">
                              <i class="bi bi-eye"></i>
                            </Link>
                            <Link :href="route('admin.account-details.edit', account.id)"
...
const applyFilters = () => {
  router.get(route('admin.account-details.index'), filters, {
    preserveState: true,
    preserveScroll: true
  })
}
...
const toggleStatus = (account) => {
  router.put(route('admin.account-details.toggle-status', account.id), {}, {
    preserveState: true,
    onSuccess: () => {
      // 更新狀態成功
    }
...
const deleteAccount = (account) => {
  if (confirm('確定要刪除此會計科目嗎？')) {
    router.delete(route('admin.account-details.destroy', account.id), {
      preserveState: true
    })
  }
}
...
class AccountManagementTest extends TestCase
{
    public function test_user_can_view_account_list()
    {
        ...
        $response = $this->actingAs($user)
            ->get(route('admin.account-details.index'));
