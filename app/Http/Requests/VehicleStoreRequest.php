...
class VehicleStoreRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'registration_year_republic' => 'nullable|integer|min:1|max:200',
    ...
    public function messages(): array
    {
        return [
            ...
            'registration_year_republic.min' => '入籍年份不能小於民國1年',
            'registration_year_republic.max' => '入籍年份不能超過民國200年',
            'registration_month.min' => '入籍月份必須在1-12之間',
            'registration_month.max' => '入籍月份必須在1-12之間',
            'registration_day.min' => '入籍日期必須在1-31之間',
            'registration_day.max' => '入籍日期必須在1-31之間',
        ];
    }
    ...
    public function attributes(): array
    {
        return [
            ...
            'inspection_day' => '檢驗日',
            'registration_year_republic' => '入籍年',
            'registration_month' => '入籍月',
